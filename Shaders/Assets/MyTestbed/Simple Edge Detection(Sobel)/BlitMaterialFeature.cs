...
{
    [SerializeField] BlitMaterialFeatureSettings settings;
    BlitMaterialFeaturePass m_ScriptablePass;

    /// <inheritdoc/>
    public override void Create()
    {
        m_ScriptablePass = new BlitMaterialFeaturePass(settings);
    ...
    class BlitMaterialFeaturePass : ScriptableRenderPass
    {
        ...
        public BlitMaterialFeaturePass(BlitMaterialFeatureSettings settings)
        {
