...
[VolumeComponentMenu("Post-processing Custom/Outline")]
...
public sealed class OutlineVolumeComponent : VolumeComponent, IPostProcessComponent
{
    ...
    public BoolParameter isOn = new BoolParameter(true, true);
    public ClampedFloatParameter OutlineNormalThreshold = new ClampedFloatParameter(0, 0f, 1f, true);
    public ClampedFloatParameter OutlineDepthThreshold = new ClampedFloatParameter(0, 0f, 1f, true);
