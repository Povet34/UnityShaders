...
public sealed class OutlineRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        OutlineVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<OutlineVolumeComponent>();
    ...
    public override void SetupRenderPasses(ScriptableRenderer renderer, in RenderingData renderingData)
    {
        ...
        // Set up the render pass for the render graph system path.
        m_FullScreenPass.renderPassEvent = RenderPassEvent.BeforeRenderingPrePasses;
        m_FullScreenPass.ConfigureInput(ScriptableRenderPassInput.None);
        m_FullScreenPass.SetupMembers(m_Material, 0, renderer.cameraColorTargetHandle);
    }
    ...
    private class CustomPostRenderPass : ScriptableRenderPass
    {
        ...
        public void SetupMembers(Material material, int passIndex, RTHandle t)
        {
            m_Material = material;
        ...
        public void UpdateMaterial()
        {
            ...
            var sc = s.GetComponent<OutlineVolumeComponent>();

            Texture Depth = Shader.GetGlobalTexture("_CameraDepthTexture");
            Texture Normal = Shader.GetGlobalTexture("_CameraNormalsTexture");

            m_Material.SetFloat("_DepthThreshold", sc.OutlineDepthThreshold.value);
            m_Material.SetFloat("_NormalThreshold", sc.OutlineNormalThreshold.value);
            m_Material.SetColor("_OutlineColor", sc.OutlineColor.value);

            m_Material.SetTexture("Depth", Depth);
            m_Material.SetTexture("_Normal", Normal);
        }
